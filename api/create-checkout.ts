...
export default async (req: Request) => {
  ...
  if (productKey === "registration") {
    ...
    productName = "League Registration Entry";
    ...
    productName = "Team Entry Registration";
    ...
    productName = `Shares in ${playerName}`;
    ...
    productName = `Shares in Team: ${teamName}`;
  } else {
